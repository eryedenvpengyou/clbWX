  ...
  <div  v-if="edit">
    <div class="hotelReserve" v-if="hotel">
      ...
      <div class="whole_new">
        ...
        <group style="min-height: 3rem;display: flex">
      ...
      <div class="whole_new">
        ...
        <group>
          <datetime v-model="data.checkinDate" format="YYYY/MM/DD HH:mm" :title="startTime" :start-date="dateTime" :min-hour="hours" placeholder="请选择"></datetime>
        </group>
      </div>
      ...
      <div class="whole_new">
        ...
        <group>
          <datetime v-model="data.checkoutDate" format="YYYY/MM/DD HH:mm" :start-date="dateTime" :min-hour="hours" :title="endTime" placeholder="请选择"></datetime>
        </group>
      </div>
    ...
    <div class="hotelReserve" v-if="club">
      ...
      <div class="whole_new">
        ...
        <group style="min-height: 3rem;display: flex">
          <datetime v-model="data.reserveDate" format="YYYY/MM/DD HH:mm" :start-date="dateTime" :min-hour="hours" :title="start"></datetime>
        </group>
      </div>
    ...
    <div class="hotelReserve" v-if="car">
      ...
      <div class="whole_new">
        <div class="left"><span style="color:#f63636 ">*</span>预约时间</div>
        <group style="min-height: 3rem;display: flex">
          <datetime v-model="data.reserveDate" format="YYYY/MM/DD HH:mm" :start-date="dateTime" :min-hour="hours" :title="start" placeholder="请选择"></datetime>
        </group>
      </div>
      <!--<group>-->
        <!--<datetime v-model="data.reserveDate" format="YYYY/MM/DD HH:mm" :title="start"></datetime>-->
    ...
    <div class="hotelReserve" v-if="HPV">
      ...
      <div class="whole_new">
        ...
        <group>
          <datetime v-model="data.reserveDate" format="YYYY/MM/DD HH:mm" :title="start" :start-date="dateTime" :min-hour="hours" placeholder="请选择"></datetime>
        </group>
      </div>
...
//      var orderId=vm.$route.query.orderId.substr(-14);
    ...
    changePath(){
      ...
      for(let i in vm.detail.prdItemSublineList){
        if(vm.data.sublineItemName===vm.detail.prdItemSublineList[i].sublineItemName){
          ...
          vm.data.price1=vm.data.price;
          if(vm.data.price!=="实时报价"){
            vm.data.price=vm.data.price?"￥"+vm.data.price:'';
          }
        }
      }
        ...
        for(let i in vm.detail.prdItemSublineList ){
          if(vm.data.sublineItemName===vm.detail.prdItemSublineList[i].sublineItemName){
            ...
            if(vm.type1){
              ...
              vm.data.price=vm.data.price?'￥'+vm.detail.prdItemSublineList[i].price:'';
            }
          }
        }
      }
