...
<script type="text/ecmascript-6">
  import {Group,PopupRadio} from 'vux';
    export default {
      ...
      computed:{
        isFullFill:function(){
          if (this.$store.state.product.minClassName === '高端医疗') {
            if(this.inputAge&&this.optionsNation&&this.option6&&this.option7&&this.option8&&this.option9){
              return true;
            }
          } else {
      ...
      methods:{
        ...
        getAmount(){
          ...
          let _this = this,
            url = '/api/cmn/productionCalcPremium',channelIdValue;
          ...
          if(window.localStorage.isApp ==='Y'){
              ...
              _this.$post(fetchurl, {})
                ...
                if (response.success == true) {
                  _this.appUserInfo = response.rows[0];
          ...
          let params = {
            ...
            minClass: _this.$store.state.product.minClass,
            securityLevel:_this.option7,
            securityArea: _this.option8,
