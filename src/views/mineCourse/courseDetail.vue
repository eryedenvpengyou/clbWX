<template>
  <div class="courseDetail" v-if="showInfo">
    ...
    <div class="date">
      <div v-if="!(list.url == null && list.boutiqueUrl != null )" class="left">直播链接：</div>
      <div v-if="(list.url  == null && list.boutiqueUrl != null )" class="left">视频链接：</div>
      <!--<a class="right_new" :href="list.url" v-if="list.url!==null">点我看直播</a>-->
      <a   class="right_new"     :href="list.url"          v-if="(list.url != null && list.boutiqueUrl != null)">点我看课程</a>
      <div class="right_new1"                               v-if="(list.url == null && list.boutiqueUrl == null)">点我看课程</div>
      <a   class="right_new"     :href="list.url"          v-if="(list.url != null && list.boutiqueUrl == null)">点我看课程</a>
      <a   class="right_new"     :href="list.boutiqueUrl"  v-if="(list.url == null && list.boutiqueUrl != null )">点我看视频</a>
    </div>
...
//          vm.$set(vm.list, 'btn1', flase);
    ...
    console.debug(vm.list.url != null && vm.list.boutiqueUrl != null);
    console.debug(vm.list.url == null && vm.list.boutiqueUrl == null);
    console.debug(vm.list.url != null && vm.list.boutiqueUrl == null);
    console.debug(vm.list.url == null && vm.list.boutiqueUrl != null);
  ...
  ,
    preview(index)
    {
      ...
      if(i!==-1){
          vm.showInfo=false;
          vm.testpdfurl= window.localStorage.wxToken;
          vm.isshowpdf=true;
        }
