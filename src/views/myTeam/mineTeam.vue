    ...
    <div class="mineTeam">
      <div class="header">
        <div class="cardList">
          ...
          <span>佣金分成级别: &nbsp;{{remember.rate1}},{{remember.rate2}},{{remember.rate3}},{{remember.rate4}},{{remember.rate5}},{{remember.rate6}},{{remember.rate7}},{{remember.rate8}},{{remember.rate9}},{{remember.rate10}}</span>
        ...
        <div class="tabContent">
          <group>
            <cell
              :title="planCount"
              is-link
               @click.native="goPage('planList2',remember.channelId,'plan')"></cell>
            <cell
              :title="orderCount"
              is-link
          ...
          <div class="cell1">
            <group>
              <cell
                :title="pendingCount"
                is-link
                @click.native="goPage('planList2',remember.channelId,'pending')"></cell>
            </group>
          </div>
          <group>
            <cell
