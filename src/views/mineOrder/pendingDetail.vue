<template>
  <div class="searchPendingInfo">
    <div class="header" @click="showPending()" v-show="!show">
    ...
    <div class="pendingInfo" v-show="!show">
      <div class="title">{{list.orderInfo}}</div>
      ...
      <div class="pending">
        <scroller
          ...
          :bounce="isbounce">
          <div v-show="show">
              <div class="pendingTitle" v-if="show">pending进度</div>
              <timeline>
              ...
              <div class="footer" @click="showPending()">关闭</div>
          </div>
        </scroller>
      </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    components: {
      Scroller,Timeline, TimelineItem
    },
    data()
  {
    return {
  ...
  methods: {
    showPending: function () {
      ...
      if(this.show == true){
        this.$nextTick(() => {
          this.$refs.pendingScroller.reset();
        })
      }
    }
  },
